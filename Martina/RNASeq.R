...
setwd("/Users/age/Desktop/MARTINA/RAW//")
dir()

targets = dir(pattern = "*HCC1599*")
...
hist(cpm(y.raw, log = TRUE, prior.count = 1) , breaks = 20)
plot(density(cpm(y.raw, log = TRUE, prior.count = 1)))
...
topTags(y.de.AvsC, n=100)$table
topTags(y.de.AvsC, n=Inf)$table

y.de.AvsC.res <- topTags(y.de.AvsC, n=Inf, sort.by = "p.value")$table

y.de.AvsC.res[y.de.AvsC.res$FDR<0.05,]
...
results.de = y.de.AvsC.res #salvi tutti
results.de = y.de.AvsC.res[y.de.AvsC.res$FDR<0.05,] #salvi solo con FDR<0.05
